...
processNsJsonString = urllib.urlopen('http://10.34.58.65:9090/api/v1/query?query=avg(avg_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_ns[' + timeWindow + ']))%20by%20(samza_job)').read()
windowNsJsonString = urllib.urlopen('http://10.34.58.65:9090/api/v1/query?query=avg(avg_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_ns[' + timeWindow + ']))%20by%20(samza_job)').read()
avgProcessCallsJsonString = urllib.urlopen('http://10.34.58.65:9090/api/v1/query?query=avg(((sum_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])-(min_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])*count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])))/count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + ']))/(count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])/2))%20by%20(samza_job)').read()
avgWindowCallsJsonString = urllib.urlopen('http://10.34.58.65:9090/api/v1/query?query=avg(((sum_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])-(min_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])*count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])))/count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + ']))/(count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])/2))%20by%20(samza_job)').read()
sumProcessCallsJsonString = urllib.urlopen('http://10.34.58.65:9090/api/v1/query?query=sum(((sum_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])-(min_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])*count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])))/count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + ']))/(count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:process_calls[' + timeWindow + '])/2))%20by%20(samza_job)%20').read()
sumWindowCallsJsonString = urllib.urlopen('http://10.34.58.65:9090/api/v1/query?query=sum(((sum_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])-(min_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])*count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])))/count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + ']))/(count_over_time(samza:org_apache_samza_container_SamzaContainerMetrics:window_calls[' + timeWindow + '])/2))%20by%20(samza_job)%20').read()
