...
# http://tableaufriction.blogspot.com/2012/11/finally-you-can-use-tableau-data-colors.html  -> colors: ['#1F77B4', '#AEC7E8', '#FF7F0E', '#FFBB78', '#2CA02C', '#98DF8A', '#D62728', '#98DF8A', '#9467BD', '#98DF8A', '#8C564B', '#C49C94', '#CFECF9', '#F7B6D2', '#7F7F7F', '#C7C7C7', '#BCBD22', '#DBDB8D', '#17BECF', '#9EDAE5']
workerColors = {'TimeApplication': '#1F77B4', 'FieldObjectStateGenerationApplication': '#AEC7E8', 'DistanceAndSpeedAnalysisApplication': '#FF7F0E', 'PassCombinationDetectionApplication': '#FFBB78', 'PressingAnalysisApplication': '#2CA02C', 'HeatmapApplication': '#98DF8A', 'KickDetectionApplication': '#D62728', 'TeamAreaApplication': '#98DF8A', 'PassAndShotDetectionApplication': '#9467BD', 'SetPlayDetectionApplication': '#98DF8A', 'AreaDetectionApplication': '#8C564B', 'KickoffDetectionApplication': '#C49C94', 'OffsideApplication': '#CFECF9', 'BallPossessionApplication': '#F7B6D2', 'BallFieldSideApplication': '#7F7F7F'}
